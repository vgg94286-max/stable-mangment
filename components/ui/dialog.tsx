...
function DialogContent({
  ...
  return (
    <DialogPortal>
      <DialogOverlay />
      {/* 
        1. Added DialogPrimitive.Viewport as the full-screen flex container 
        to handle centering safely without CSS transforms.
      */}
      <DialogPrimitive.Viewport className="fixed inset-0 z-50 flex items-center justify-center">
        <DialogPrimitive.Popup
          data-slot="dialog-content"
          /* 
            2. Removed: fixed, top-1/2, left-1/2, -translate-x-1/2, -translate-y-1/2 
            3. Added: relative 
          */
          className={cn(
